...
import { Wrapper, Chapter, Header } from "../../styles/About/Statute.style";
    ...
    <Wrapper>
      ...
      <Chapter>
        ...
        <ol>
          <li>
            ...
            pracowników. Pracownikiem może być każdy członek Stowarzyszenia oraz
            osoby nienależące do Stowarzyszenia,
          </li>
          <li>
          ...
          <li>
            Stowarzyszenie może zakupić przedmioty, sprzęt, nieruchomości, know
            how itp. niezbędne do realizacji celów statutowych Stowarzyszenia,
          </li>
          <li>
      ...
      <Chapter>
        ...
        <p>
          ...
          aktywnością intelektualną. Cel ten będzie popularyzowany i realizowany
          wśród członków Stowarzyszenia oraz osób wyrażających chęć uczestnictwa
          w projektach realizowanych przez Stowarzyszenie.
        </p>
        <Header>10</Header>
        <p>
        ...
        <ol>
          <li>
            ...
            sportu, rekreacji ruchowej i turystycznej wśród dzieci, młodzieży i
            dorosłych, w szczególności poprzez promowanie takich dyscyplin
